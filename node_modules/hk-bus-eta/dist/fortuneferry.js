...
function fetchEtas({ stops: { fortuneferry: stops }, seq, holidays, freq, serviceDayMap, }) {
    if (seq >= 1)
        return Promise.resolve([]);
    const now = new Date();
    return Promise.resolve((0, utils_1.getUpcomingFerry)({ holidays, serviceDayMap, freq, date: new Date() })
...
//# sourceMappingURL=fortuneferry.js.map